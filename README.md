...
---
3. **Simple Neural Network**: 2-layered neural network which mimics the XOR gate, made from scratch(vectorized) using NumPy.
---
4. **Digit-Classification**: Dataset used: MNIST  
    ...
    - Both of the above networks are 2-layered and are implemented from scratch(vectorized) using NumPy.
